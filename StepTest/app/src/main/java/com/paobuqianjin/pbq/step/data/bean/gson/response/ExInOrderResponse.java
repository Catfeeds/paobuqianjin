...
public class ExInOrderResponse {
    ...
    private ExInOrderResponse.DataBeanX data;
    ...
    public ExInOrderResponse.DataBeanX getData() {
        return data;
    }

    public void setData(ExInOrderResponse.DataBeanX data) {
        this.data = data;
    }
    ...
    public static class DataBeanX {
        ...
        private ExInOrderResponse.DataBeanX.PagenationBean pagenation;
        private List<ExInOrderResponse.DataBeanX.DataBean> data;

        public ExInOrderResponse.DataBeanX.PagenationBean getPagenation() {
            return pagenation;
        }

        public void setPagenation(ExInOrderResponse.DataBeanX.PagenationBean pagenation) {
            this.pagenation = pagenation;
        }

        public List<ExInOrderResponse.DataBeanX.DataBean> getData() {
            return data;
        }

        public void setData(List<ExInOrderResponse.DataBeanX.DataBean> data) {
            this.data = data;
        }
