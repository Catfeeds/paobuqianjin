...
public class NetApi {
    ...
    //圈子接口
    public final static String urlCircle = "http://119.29.10.6/v1/Circle";
    //圈子类型接口
    public final static String urlCircleType = "http://119.29.10.6/v1/CircleTypeResponse";
    //圈子目标接口
    public final static String urlTarget = "http://119.29.10.6/v1/CircleTarget";
    //圈子成员接口
    public final static String urlCircleMember = "http://119.29.10.6/v1/CircleMember";
    //圈子订单类型接口
    ...
    //圈子封面接口
    public final static String urlCircleCover = "http://119.29.10.6/v1/CircleCover";


    //手机号登陆、微信登陆、微博登陆统一接口 请求方式post 地址：http://pb.com/v1/user/login 参数：mobile、password
    public final static String urlUserLogin = "http://119.29.10.6/v1/user/login";
    //发送验证码接口 请求方式 get,地址：http://pb.com/v1/user/sendmsg 参数：mobile 状态：0成功 -1失败
    public final static String urlSendMsg = "http://119.29.10.6/v1/user/sendMsg/?mobile=";
    //获取附近的人接口，请求方式：get 地址：http://pb.com/v1/user/?latitude=35.17000&longitude=86.26000，暂定10万米之内
    public final static String urlNearByPeople = "http://119.29.10.6/v1/user/?latitude=35.17000&longitude=86.26000";
    //手机号注册账号 请求方式post 地址：http://pb.com/v1/user 参数：mobile、password、code
    public final static String urlRegisterPhone = "http://119.29.10.6/v1/user/";
    //请求类型put 地址：http://pb.com/v1/user/18276810055 参数：code和password加在put中
    public final static String urlFindPassWord = "http://119.29.10.6/v1/user/";
    //获取用户信息 请求方式get 地址：http://pb.com/v1/user/用户id
    public final static String urlUser = "http://119.29.10.6/v1/user/";


    /*用户登陆记录   http://pb.com/v1/userrecord*/
    //请求方式：get，http://pb.com/v1/userrecord/?id=2 参数用户id
    public final static String urlUserRecord = "http://119.29.10.6/v1/userrecord/?id=";
    //请求方式：post，地址：http://pb.com/v1/userrecord，参数：用户id、经度longitude、纬度latitude
    public final static String urlUserRecordPost = "http://119.29.10.6/v1/userrecord";

    /*用户步数*/
    //请求方式get/post，地址：http://pb.com/v1/userstep/1 参数：用户id
    public final static String urlUserStep = "http://119.29.10.6/v1/userstep/";
    //用户收益接口
    ...
    public final static String urlIncome = "http://119.29.10.6/v1/income/?id=1&action=yesterday";
    //请求方式post，地址：http://pb.com/v1/income，参数：userid（用户id）、typeid（收益类型）、circleid（圈子id）、amount（收益金额）
    public final static String urlIncomePost = "http://119.29.10.6/v1/income";

    //用户身份认证接口
    //用户认证，请求方式：post，地址：http://api.runmoneyin.com/v1/userauthentication，参数：id（用户id）、idcard（身份证号）、realname（真实名字）
    public final static String urlAuthentication = "http://119.29.10.6/v1/userauthentication";
    //获取用户认证状态，请求方式：get，地址：http://api.runmoneyin.com/v1/userauthentication/5（用户id）
    public final static String getUrlAuthenticationState = "http://119.29.10.6/v1/userauthentication/";

    //用户收益额类型
    //用户收益类型相关接口，地址：http://api.runmoneyin.com/v1/incometype/?id=1
    public final static String urlIncomeType = "http://119.29.10.6/v1/incometype/?id=";

    //获取用户步币详细信息
    //获取用户步币详细信息，请求方式：get，地址：http://api.runmoneyin.com/v1/usercredit/?id=5
    public final static String urlCredit = "http://119.29.10.6/v1/usercredit/?id";

    //我的提现接口
    //获取用户提现信息记录，请求方式：get，地址：http://api.runmoneyin.com/v1/withdraw/2，参数：用户id
    public final static String urlWithDraw = "http://119.29.10.6/v1/withdraw/";
    ...
    public final static String urlUserInviter = "http://119.29.10.6/v1/userinviter";
    //获取我邀请的人数，请求方式：get，地址：http://api.runmoneyin.com/v1/userinviter/1

    //用户关注接口
    //我的关注：get http://api.runmoneyin.com/v1/UserFollow?userid=5
    public final static String urlUserFollow = "http://119.29.10.6/v1/UserFollow";
