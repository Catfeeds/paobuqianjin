...
public class ExchangeOutActivity extends BaseBarActivity {
    ...
    private void initTab() {
        ...
        viewpager.setAdapter(new TabAdapter(ExchangeOutActivity.this, getSupportFragmentManager(), fragments, titles));
        ...
        tablayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                try {
                    ...
                    if (tv != null) {
                        tv.setTextColor(ContextCompat.getColor(ExchangeOutActivity.this, R.color.color_232433));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            public void onTabUnselected(TabLayout.Tab tab) {
                ...
                try {
                    TextView tv = (TextView) customView.findViewById(R.id.tv_tab_title);
                    if (tv != null) {
                        tv.setTextColor(ContextCompat.getColor(ExchangeOutActivity.this, R.color.color_161727));
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
