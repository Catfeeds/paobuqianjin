...
public class ConsumptiveRdBagAdapter extends RecyclerView.Adapter<ConsumptiveRdBagAdapter.ShopSendedRedBagHolder> {
    ...
    public ConsumptiveRdBagAdapter(Context context, List<ShopSendedRedBagResponse.ShopSendedRedBagBean> listData) {
