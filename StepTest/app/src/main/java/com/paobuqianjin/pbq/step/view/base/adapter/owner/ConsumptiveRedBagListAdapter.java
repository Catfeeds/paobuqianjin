...
public class ConsumptiveRedBagListAdapter extends RecyclerView.Adapter<ConsumptiveRedBagListAdapter.ShopSendedRedBagHolder> {
...
//        Presenter.getInstance(context).getImage(holder.iv_icon, itemBean.getBusinesslogo());
        ...
        switch (itemBean.getStatus()) {//0可领取|1条件不符|2已领过|3已领完
            case 0:
                holder.tv_status.setText(R.string.pull_down_now);
                ...
                break;
            case 1:
                holder.tv_status.setText(R.string.condition_unavaliable);
                ...
                break;
            case 2:
                holder.tv_status.setText(R.string.already_pull_down);
                holder.tv_status.setTextColor(context.getResources().getColor(R.color.color_9e9e9e));
                holder.tv_status.setBackgroundResource(R.drawable.shape_14_dp_gray);
                holder.tv_status.setOnClickListener(null);
                break;
            case 3:
                holder.tv_status.setText(R.string.already_pull_down_over);
                holder.tv_status.setTextColor(context.getResources().getColor(R.color.color_9e9e9e));
                holder.tv_status.setBackgroundResource(R.drawable.shape_14_dp_gray);
                holder.tv_status.setOnClickListener(null);
                break;
