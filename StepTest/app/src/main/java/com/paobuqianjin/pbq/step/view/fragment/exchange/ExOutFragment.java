...
import com.paobuqianjin.pbq.step.view.activity.exchange.AddExAddrActivity;
...
public class ExOutFragment extends BaseFragment implements SwipeMenuRecyclerView.LoadMoreListener, SwipeRefreshLayout.OnRefreshListener, UpItemInterface {
    ...
    private ExOutAdapter exOutAdapter;
    //发货
    ...
    private List<ExOutOrderResponse.DataBeanX.DataBean> listData = new ArrayList<>();
    ...
    private void getExOrderByAction(final int page) {
        ...
        Presenter.getInstance(getContext()).postPaoBuSimple(NetApi.urlExOrderOut, param, new PaoCallBack() {
            ...
            protected void onSuc(String s) {
                ...
                try {
                    ExOutOrderResponse exOutOrderResponse = new Gson().fromJson(s, ExOutOrderResponse.class);
    ...
    protected void initView(View viewRoot) {
        ...
        exOutAdapter = new ExOutAdapter(getContext(), listData);
