...
public class MonthIncomeFragment extends BaseFragment {
    ...
    RecyclerView todayIncomeRecycler;
    ...
    protected void initView(View viewRoot) {
        ...
        todayIncomeRecycler = (RecyclerView) viewRoot.findViewById(R.id.month_income_recycler);
    ...
    public void setData(IncomeResponse incomeResponse) {
        if (todayIncomeRecycler != null) {
            todayIncomeRecycler.setAdapter(new WalletRedPkgIncomeAdapter(getContext(),incomeResponse.getData().getData()));
        }
    }
    @Override
