...
public class YesterDayIncomeFragment extends BaseFragment {
    ...
    protected void initView(View viewRoot) {
        ...
        yesterdayIncomeRecycler.addFooterView(loadMoreView); // 添加为Footer。
        yesterdayIncomeRecycler.setLoadMoreView(loadMoreView); // 设置LoadMoreView更新监听。
        if (loadMoreListener != null) {
            yesterdayIncomeRecycler.setLoadMoreListener(loadMoreListener); // 加载更多的监听。
        }
    ...
    public void loadMoreFinish(boolean dateEmpty, boolean hasMore) {
        if (yesterdayIncomeRecycler != null) {
            yesterdayIncomeRecycler.loadMoreFinish(dateEmpty, hasMore);
        } else {
    ...
    public void scrollTop() {
        if (yesterdayIncomeRecycler != null) {
            yesterdayIncomeRecycler.postDelayed(new Runnable() {
                @Override
                public void run() {
